...
public class HeadLessHtmlUnitDriver extends LibraryFunctions {
	...
	public void EnterGMOnline() {
		...
		String text = LibraryFunctions.FindElementUsingHeadLess(unitDriver,ObjectRepository2.GMO_OnlineCatalog).getText();
