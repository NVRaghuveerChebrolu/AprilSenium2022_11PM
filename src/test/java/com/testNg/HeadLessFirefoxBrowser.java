...
public class HeadLessFirefoxBrowser extends LibraryFunctions {
	WebDriver driver;
	@Test(priority = 0)
	...
	public void EnterGMOnline() {
		...
		// driver.findElement(By.name(ObjectRepository2.submitbuttonGmoOnline)).click();
		driver.findElement(By.name("bSubmit")).click();
		//String text = driver.findElement(By.xpath("//h1[contains(text(),'OnLine Catalog')]")).getText();
		//LibraryFunctions.FindElementUsingHeadLess(driver,ObjectRepository2.submitbuttonGmoOnline).click();
